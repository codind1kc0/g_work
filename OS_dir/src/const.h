...
#define    HEAP_BASE          0x70000
#define    HEAP_SIZE          0x20000
#define    KERNEL_HEAP_BASE   HEAP_BASE
#define    APP_HEAP_BASE      (HEAP_BASE - HEAP_SIZE)

#define    PAGE_DIR_BASE      (HEAP_BASE + HEAP_SIZE)
#define    PAGE_TBL_BASE      (PAGE_DIR_BASE + 0x1000)

#define    BASE_OF_KERNEL     0XB000
#define    BASE_OF_APP        0X10000


#define    BASE_OF_SHARED_MEMERY    0XA000
#define    APP_MAIN_ENTRY           (BASE_OF_SHARED_MEMERY + 36)
