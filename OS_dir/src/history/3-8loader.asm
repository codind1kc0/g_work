...
PAGE_TBL_DESC0 Descriptor    page_tbl_base0,   1023,           DA_DRW | DA_LIMIT_4K | DA_32

PAGE_DIR_DESC1 Descriptor    page_dir_base1,   4095,           DA_DRW | DA_32
PAGE_TBL_DESC1 Descriptor    page_tbl_base1,   1023,           DA_DRW | DA_LIMIT_4K | DA_32
...
; print on page table zero: 0x401000
    mov ax, flat_mode_selector
	mov ds, ax
...
; choose page table one
	...
	call switch_page_tbl_selector : 0
; print on page table one: 0x401000
	mov ax, flat_mode_selector
	mov ds, ax
