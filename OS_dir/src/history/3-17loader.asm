...
IDT_ENTRY:
%rep 32 
    Gate      code32_selector,  def_handle,     0,  DA_386IGATE
%endrep
; 0x20
int0x20:
    Gate      code32_selector,  timer_handle,   0,  DA_386IGATE
; 0x80
%rep 95 
    Gate      code32_selector,  def_handle,     0,  DA_386IGATE
%endrep
...
int0x80_desc: 
    Gate      code32_selector,  int0x80_handle, 0,  DA_386IGATE
...
; open IF, open timer int
    sti
    call enable_timer

    mov ax, data_selector
	mov ds, ax
	mov esi, int0x80_str_off
	mov bh, 0x0c
	mov dx, 0x0900
	int 0x80
;   INTERRUPT
