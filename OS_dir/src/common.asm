sys_address:
	...
	base_of_app         equ       0x10000

	base_of_shared_memery equ     0xa000

	heap_base           equ       0x70000
	heap_size           equ       0x20000
	kernel_heap_base    equ       heap_base
	app_heap_base       equ       ( heap_base - heap_size )

page_addr:
    page_dir_base        equ       (heap_base + heap_size) 
	page_tbl_base        equ       (page_dir_base + 0x1000)
...
shared_value_adress:
	...
	send_EOI_entry       equ       (base_of_shared_memery + 28)
	load_task_entry      equ       (base_of_shared_memery + 32)
	app_main_entry       equ       (base_of_shared_memery + 36)
